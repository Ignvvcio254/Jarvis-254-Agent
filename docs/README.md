# Documentación — Jarvis-254-Agent

Índice de referencia completo. Para empezar, leer [README.md](../README.md) en el root.

| Documento | Cuándo acudir |
|---|---|
| [commands.md](commands.md) | Catálogo detallado de comportamiento por slash command |
| [command-skill-matrix.md](command-skill-matrix.md) | Matriz comando ↔ skill ↔ workflow |
...
| [agents.md](agents.md) | Roles y capacidades de agentes disponibles |
| [context-compression.md](context-compression.md) | Contrato de compresión de contexto y protect_n |